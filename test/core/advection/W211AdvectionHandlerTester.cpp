...
BOOST_AUTO_TEST_CASE(checkAdvection)
{
	...
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[1], -8.2343e+10, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[3], -1.2691e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[5], -2.1122e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[7], -3.8613e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[9], -4.6389e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[11], -2.5188e+10, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[13], -8.6496e+09, 0.01);
	BOOST_REQUIRE_CLOSE(
	...
	BOOST_REQUIRE_CLOSE(valMirror[0], -332783240.0, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[1], 20798953.0, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[2], -403616596.0, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[3], 25226037.0, 0.01);
