...
BOOST_AUTO_TEST_CASE(checkAdvection)
{
	...
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[1], -2.2196e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[3], -2.1449e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[5], -2.7266e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[7], -4.9104e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[9], -7.0692e+11, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[11], -2.7438e+10, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[13], -8.0136e+09, 0.01);
	BOOST_REQUIRE_CLOSE(
	...
	BOOST_REQUIRE_CLOSE(valMirror[0], -4.76468e+07, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[1], 1.50758e+07, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[2], -4.36444e+07, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[3], 1.38094e+07, 0.01);
