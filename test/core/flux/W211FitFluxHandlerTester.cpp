...
BOOST_AUTO_TEST_CASE(checkComputeIncidentFlux)
{
	...
	auto testFitFlux = make_shared<W211FitFluxHandler>(opts);
	...
	BOOST_REQUIRE_CLOSE(newConcentration(1, 0), 0.385429, 0.01);
	BOOST_REQUIRE_CLOSE(newConcentration(2, 0), 0.286585, 0.01);
	BOOST_REQUIRE_CLOSE(newConcentration(3, 0), 0.127985, 0.01);
