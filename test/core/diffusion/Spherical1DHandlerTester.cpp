...
/**
 * This suite is responsible for testing the Spherical1DHandler.
 */
BOOST_AUTO_TEST_SUITE(Spherical1DHandler_testSuite)
...
BOOST_AUTO_TEST_CASE(checkDiffusion)
{
	...
	Spherical1DHandler diffusionHandler(opts.getMigrationThreshold());
	...
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[1], 7.8525e+12, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[3], 4.27300e+12, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[5], 1.89110e+12, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[7], 2.7240e+12, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[9], 2.1962e+12, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[11], 5.85778e+10, 0.01);
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[13], 9.8330e+09, 0.01);
	BOOST_REQUIRE_CLOSE(
		updatedConcOffsetMirror[15], 0.0, 0.01); // He_8 does not diffuse
	BOOST_REQUIRE_CLOSE(updatedConcOffsetMirror[0], 5.8414e+08, 0.01);
	...
	BOOST_REQUIRE_CLOSE(valMirror[1], -505312.69, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[4], -6415444736, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[5], 6415444736, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[6], 0.0, 0.01);
	BOOST_REQUIRE_CLOSE(valMirror[10], -1264105042, 0.01);
