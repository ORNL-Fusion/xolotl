...
BOOST_AUTO_TEST_CASE(fullyRefined) {
	...
	paramFile << "netParam=3 0 0 3 1" << std::endl << "process=reaction"
			<< std::endl;
	paramFile.close();
	...
	NetworkType network( { (NetworkType::AmountType) opts.getMaxImpurity(),
			...
			(NetworkType::AmountType) opts.getMaxI() }, 1, opts);
	...
	BOOST_REQUIRE_CLOSE(network.getTotalConcentration(dConcs, Spec::He, 1),
			12.0, 0.01);
	BOOST_REQUIRE_CLOSE(network.getTotalAtomConcentration(dConcs, Spec::V, 3),
			12.0, 0.01);
	...
	BOOST_REQUIRE_CLOSE(network.getLeftSideRate(dConcs, 0, gridId), 94327839814,
			0.01);
	...
	std::vector<double> knownFluxes = { -9.43288e+10, -5.16275e+11,
			-5.63061e+11, -6.10778e+11, -4.75639e+12, -1.45044e+11,
			-1.55625e+11, -1.69757e+11, -7.60177e+11, 1.45774e+11, 1.57282e+11,
			1.59414e+11, 2.6994e+11, 5.20973e+11, 5.63078e+11, 5.86753e+11, 0 };
	...
	std::vector<double> knownPartials = { -9.43288e+10, -7.01816e+09,
			-7.91224e+09, -1.03421e+10, -6.86896e+09, -7.76165e+09,
			-8.38785e+09, -6.86896e+09, -7.76165e+09, -8.38785e+09,
			-6.86896e+09, -7.76165e+09, -8.38785e+09, 1.10364e-10, 0.00140902,
			38.3638, -5.30342e+11, 8.94081e+08, 1.2078e+10, -2.76652e+11,
			7.84608e+08, -1.68579e+08, -1.45181e+11, -1.49194e+08, -1.68588e+08,
			-9.90247e+10, -1.49198e+08, -1.68588e+08, 1.39186e+08, 17448.6,
			26.9324, 0.13587, -5.73858e+11, 2.42983e+09, 1.04813e+10,
			2.77618e+08, -2.9965e+11, -1.50587e+08, -1.56675e+11, -1.50587e+08,
			-1.06607e+11, -1.50587e+08, 1.75351e+07, -6.1113e+11, -1.03421e+10,
			3.19175e+08, 3.19175e+08, -3.18416e+11, -1.67483e+11, -1.1475e+11,
			3.29555e+07, -6.26796e+12, 6.86896e+09, -2.68616e+11, -2.76652e+11,
			-2.9965e+11, -3.18416e+11, -2.99407e+11, -3.1553e+11, -5.83904e+11,
			-2.76419e+11, -2.99425e+11, -3.15563e+11, 4.50762e+08, 1.47931e-12,
			1.60243e-12, 1.6888e-12, -4.29458e+11, 8.92693e+08, 7.76166e+09,
			2.76503e+11, 2.32972e+08, -1.50587e+08, -1.44936e+11, 1.47931e-12,
			-4.63812e+11, 6.26203e+08, 8.38787e+09, -1.93899e+07, 1.49198e+08,
			2.9965e+11, 2.25415e+08, -1.56439e+11, 1.60243e-12, -4.88492e+11,
			-8.38785e+09, 1.68588e+08, 1.68588e+08, 1.50587e+08, 1.50587e+08,
			3.18416e+11, 2.85278e+09, -1.64509e+11, 1.6888e-12, -1.51913e+12,
			6.86896e+09, 6.86896e+09, -1.45181e+11, -1.56675e+11, -1.67483e+11,
			9.19357e+11, -1.44936e+11, -1.56439e+11, -1.64509e+11, 4.50762e+08,
			-2.83588e+11, 8.92693e+08, 7.76165e+09, 1.45032e+11, 1.45181e+11,
			-1.50587e+08, 0, 2.76419e+11, 1.47931e-12, -3.07355e+11,
			6.26203e+08, 8.38785e+09, -1.93899e+07, 1.49198e+08, 1.56675e+11,
			1.56675e+11, 0, 2.99425e+11, 1.60243e-12, -3.23951e+11,
			-8.38785e+09, 1.68588e+08, 1.68588e+08, 1.50587e+08, 1.50587e+08,
	...
	BOOST_REQUIRE_CLOSE(cluster.getDiffusionCoefficient(gridId), 49844044907.0,
			0.01);
	...
	BOOST_REQUIRE_CLOSE(cluster.getFormationEnergy(), 0.0, 0.01);
	BOOST_REQUIRE_CLOSE(cluster.getTemperature(gridId), 1000.0, 0.01);
	BOOST_REQUIRE_CLOSE(cluster.getDiffusionCoefficient(gridId), 37523834.9,
			0.01);
	...
	BOOST_REQUIRE_CLOSE(cluster.getFormationEnergy(), 0.0, 0.01);
	BOOST_REQUIRE_CLOSE(cluster.getTemperature(gridId), 1000.0, 0.01);
	BOOST_REQUIRE_CLOSE(cluster.getDiffusionCoefficient(gridId), 1934083614.2,
			0.01);
	BOOST_REQUIRE_CLOSE(cluster.getDiffusionFactor(), 100000000000.0, 0.01);
...
BOOST_AUTO_TEST_CASE(grouped) {
	...
	// Create a good parameter file
	std::ofstream paramFile("param.txt");
	paramFile << "netParam=8 0 0 8 1" << std::endl << "process=reaction"
			<< std::endl << "grouping=4 4 2" << std::endl;
	paramFile.close();
	...
	NetworkType network( { maxHe, maxV, maxI }, { { groupingWidthHe,
			groupingWidthV, maxI + 1 } }, 1, opts);
	...
	knownDFill[0] = { 0, 1, 3, 5, 7, 9, 10, 30, 11, 31, 12, 32, 13, 14, 15, 16,
			17, 18, 33, 19, 34, 20, 35, 21, 22, 23, 24, 25, 26, 27, 28, 29, 4,
			6, 8, 2 };
	knownDFill[1] = { 1, 0, 2, 4, 6, 8, 9, 10, 30, 11, 31, 12, 32, 13, 14, 15,
			16, 17, 18, 33, 19, 34, 20, 35, 21, 22, 23, 24, 25, 26, 27, 28, 29,
			3, 5, 7 };
	knownDFill[2] = { 2, 0, 29, 1, 3, 5, 7, 9, 13, 17, 24, 25, 4 };
	knownDFill[3] = { 3, 0, 1, 21, 2, 4, 5, 6, 9, 10, 30, 11, 31, 13, 14, 15,
			17, 18, 33, 19, 34, 22, 24, 25, 26, 27, 29, 7, 8, 12, 32, 16, 20,
			35, 23, 28 };
	...
	knownDFill[10] = { 10, 0, 30, 26, 1, 18, 33, 3, 9, 24, 5, 21, 13, 25, 14,
			11, 31 };
	knownDFill[11] = { 11, 0, 31, 27, 1, 19, 34, 3, 10, 30, 5, 9, 24, 22, 13,
			25, 15, 12, 32 };
	...
	knownDFill[18] = { 18, 0, 10, 30, 33, 1, 4, 3, 17, 29, 5, 9, 14, 26, 13, 25,
			19, 34 };
	...
	knownDFill[30] = { 30, 0, 10, 26, 1, 18, 33, 3, 9, 24, 5, 21, 13, 25, 14,
			11, 31 };
	knownDFill[31] = { 31, 0, 11, 27, 1, 19, 34, 3, 10, 30, 5, 9, 24, 22, 13,
			25, 15, 12, 32 };
	knownDFill[32] = { 32, 0, 12, 28, 1, 20, 35, 3, 11, 31, 5, 10, 30, 7, 9, 24,
			23, 13, 25, 16 };
	knownDFill[33] = { 33, 0, 10, 30, 18, 1, 4, 3, 17, 29, 5, 9, 14, 26, 13, 25,
			19, 34 };
	...
	// Check the left side rate of 0th cluster
	BOOST_REQUIRE_CLOSE(network.getLeftSideRate(dConcs, 0, gridId),
			535857652671, 0.01);
	...
	// Check the fluxes computation
	std::vector<double> knownFluxes = { -5.22471e+11, -2.87474e+11,
			-6.88335e+11, -9.97246e+12, -1.95141e+11, -2.56667e+12, 1.83297e+11,
			-3.42229e+11, 6.76208e+11, -6.26418e+11, -1.73419e+11, 1.73933e+11,
			6.25497e+11, -5.69668e+11, -1.58436e+11, 1.5447e+11, 5.60267e+11,
			-6.47052e+11, -1.80644e+11, 1.8585e+11, 6.62872e+11, -1.47436e+11,
			1.43382e+11, 5.18581e+11, -6.3465e+11, -6.54547e+11, -1.63843e+11,
			1.65328e+11, 5.92667e+11, -6.6449e+11, -4.99326e+11, 2.75472e+09,
			5.08372e+11, -5.28925e+11, 3.09422e+09, 5.37855e+11, 0 };
	network.computeAllFluxes(dConcs, dFluxes, gridId);
	deep_copy(hFluxes, dFluxes);
	for (NetworkType::IndexType i = 0; i < dof + 1; i++) {
		BOOST_REQUIRE_CLOSE(fluxes[i], knownFluxes[i], 0.01);
	...
	std::vector<double> knownPartials = { -5.36753e+11, 8.94081e+08,
			-2.76652e+11, -1.45181e+11, -9.90247e+10, -4.40779e+08,
			-3.95124e+08, 0, -3.95179e+08, 0, -3.9518e+08, 0, 1.2078e+10,
			-1.68579e+08, -1.68588e+08, -1.68588e+08, -2.07355e+08,
			-4.27392e+08, 0, -4.27455e+08, 0, -4.27457e+08, 0, 7.84608e+08,
			-1.49194e+08, -1.49198e+08, -1.82928e+08, -1.99721e+09,
			-1.82172e+08, -1.8219e+08, -1.8219e+08, -2.15732e+08, 31733.7,
			1492.92, 94.0114, 983384, -2.87474e+11, -7.01816e+09, -1.03034e+10,
			-1.03034e+10, -1.03034e+10, -1.03034e+10, -9.32399e+09,
			-1.81937e+10, 0, -1.81937e+10, 0, -1.81937e+10, 0, -7.91224e+09,
			-7.76165e+09, -7.76165e+09, -7.76165e+09, -9.67534e+09,
			-1.96797e+10, 0, -1.96797e+10, 0, -1.96797e+10, 0, -6.86896e+09,
			-6.86896e+09, -6.86896e+09, -9.30735e+09, -1.03421e+10,
			...
			0, -6.6767e+11, 0, -2.9965e+11, -2.99407e+11, -2.99425e+11,
			9.09689e+09, 0, 2.85278e+09, 3.16108e+11, -1.64509e+11,
			-5.12418e+08, -2.94686e+07, 1.50587e+08, 1.6888e-12, -3.27134e+11,
			-1.36016e+07, 1.68588e+08, 7.0901e+08, 9.09686e+09, 0, 0,
			3.15563e+11, 1.67483e+11, 1.65175e+11, -5.12418e+08, -2.94686e+07,
			1.50587e+08, 1.6888e-12, -1.15706e+10, -1.36016e+07, 1.68588e+08,
			7.0901e+08, 9.09686e+09, 0, 3.15563e+11, 3.15563e+11, 1.64509e+11,
			1.64509e+11, 1.1475e+11, 1.12442e+11, -5.12418e+08, -2.94686e+07,
			1.50587e+08, -6.78224e+11, -7.14739e+06, 2.10155e+08, 2.99036e+08,
			1.03044e+10, -3.57224e+11, -1.85339e+11, -1.25438e+11, 2.93665e+09,
			2.93665e+09, 1.97895e+08, 1.97895e+08, 5.622e+07, 0, -5.10766e+11,
			-2.80985e+08, 7.43386e+08, -2.13458e+06, 0, 31096.8, -15548.4,
			-3.23614e+11, -3.28327e+11, 3.3926e+11, -1.73645e+11, -1.51659e+09,
			-1.81662e+08, -2.26529e+09, 1.99429e+09, 0, 1.78658e-12,
			-3.37072e+11, -2.80985e+08, 7.44924e+08, -2.13458e+06, 0, 823.624,
			-411.812, 0, 0, 3.33835e+11, 4.77137e+09, -1.70874e+11, 1.76357e+11,
			-1.51659e+09, -1.81662e+08, -2.26529e+09, 1.99429e+09, 0,
			1.78658e-12, -3.23713e+09, -2.80985e+08, 7.44924e+08, -2.13458e+06,
			0, 32.6849, -16.3425, 3.33835e+11, 0, 3.33835e+11, 1.73645e+11, 0,
			1.73645e+11, 2.90896e+09, -1.1589e+11, 1.1951e+11, -1.51659e+09,
			-1.81662e+08, -2.26529e+09, 1.99429e+09, -5.36683e+11, -4.03249e+08,
			2.27568e+09, -1.14162e+09, 4.20584e+08, 0, 31733.7, -3.44503e+11,
			-3.48743e+11, 3.57224e+11, -1.83219e+11, 3.0838e+07, -4.8158e+08,
			-1.79567e+09, 2.97924e+08, -1.07145e+09, 0, 1.88906e-12,
			-3.53408e+11, -4.03249e+08, 2.27568e+09, -1.14162e+09, 4.21954e+08,
			0, 1492.92, 0, 0, 3.52984e+11, 4.24016e+09, -1.81099e+11,
			1.85339e+11, 3.0838e+07, -4.8158e+08, -1.79567e+09, 2.97924e+08,
			-1.07145e+09, 0, 1.88906e-12, -4.24706e+08, -4.03249e+08,
			2.27568e+09, -1.14162e+09, 4.21955e+08, 0, 94.0114, 3.52984e+11, 0,
			3.52984e+11, 1.83219e+11, 0, 1.83219e+11, 2.79851e+09, -1.2264e+11,
			1.25438e+11, 3.0838e+07, -4.8158e+08, -1.79567e+09, 2.97924e+08,
			-1.07145e+09 };
	auto vals = Kokkos::View<double*>("solverPartials", nPartials);
	network.computeAllPartials(dConcs, vals, gridId);
	auto hPartials = create_mirror_view(vals);
