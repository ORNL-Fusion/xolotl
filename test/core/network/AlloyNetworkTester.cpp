...
BOOST_AUTO_TEST_CASE(traits)
{
	...
	BOOST_REQUIRE_EQUAL(toLabelString(Spec::PerfectV), "PerfectV");
	BOOST_REQUIRE_EQUAL(toLabelString(Spec::FaultedV), "FaultedV");
	BOOST_REQUIRE_EQUAL(toLabelString(Spec::I), "I");
	BOOST_REQUIRE_EQUAL(toLabelString(Spec::PerfectI), "PerfectI");
	BOOST_REQUIRE_EQUAL(toLabelString(Spec::FaultedI), "FaultedI");

	// toNameString
	BOOST_REQUIRE_EQUAL(toNameString(Spec::V), "Vacancy");
	BOOST_REQUIRE_EQUAL(toNameString(Spec::PerfectV), "PerfectV");
	BOOST_REQUIRE_EQUAL(toNameString(Spec::FaultedV), "FaultedV");
	BOOST_REQUIRE_EQUAL(toNameString(Spec::I), "Interstitial");
	BOOST_REQUIRE_EQUAL(toNameString(Spec::PerfectI), "PerfectI");
	BOOST_REQUIRE_EQUAL(toNameString(Spec::FaultedI), "FaultedI");
	...
	sid = network.parseSpeciesId("PerfectV");
	BOOST_REQUIRE(sid.cast<Spec>() == Spec::PerfectV);
	BOOST_REQUIRE_EQUAL(network.getSpeciesLabel(sid), "PerfectV");
	BOOST_REQUIRE_EQUAL(network.getSpeciesName(sid), "PerfectV");
	sid = network.parseSpeciesId("FaultedV");
	BOOST_REQUIRE(sid.cast<Spec>() == Spec::FaultedV);
	BOOST_REQUIRE_EQUAL(network.getSpeciesLabel(sid), "FaultedV");
	BOOST_REQUIRE_EQUAL(network.getSpeciesName(sid), "FaultedV");
	...
	sid = network.parseSpeciesId("PerfectI");
	BOOST_REQUIRE(sid.cast<Spec>() == Spec::PerfectI);
	BOOST_REQUIRE_EQUAL(network.getSpeciesLabel(sid), "PerfectI");
	BOOST_REQUIRE_EQUAL(network.getSpeciesName(sid), "PerfectI");
	sid = network.parseSpeciesId("FaultedI");
	BOOST_REQUIRE(sid.cast<Spec>() == Spec::FaultedI);
	BOOST_REQUIRE_EQUAL(network.getSpeciesLabel(sid), "FaultedI");
	BOOST_REQUIRE_EQUAL(network.getSpeciesName(sid), "FaultedI");
	...
	BOOST_REQUIRE_EQUAL(GroupingRange::mapToMomentId(Spec::PerfectV), 0);
	BOOST_REQUIRE_EQUAL(GroupingRange::mapToMomentId(Spec::FaultedV), 0);
	BOOST_REQUIRE_EQUAL(GroupingRange::mapToMomentId(Spec::I), 0);
	BOOST_REQUIRE_EQUAL(GroupingRange::mapToMomentId(Spec::PerfectI), 0);
	BOOST_REQUIRE_EQUAL(GroupingRange::mapToMomentId(Spec::FaultedI), 0);
}
