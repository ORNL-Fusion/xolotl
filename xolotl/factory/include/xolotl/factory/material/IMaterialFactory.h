...
public:
	 ...
	 */
	virtual void
	initializeMaterial(const options::Options& opts) = 0;
	...
	/**
	 * Function that create the wanted material factory depending on the given
	 * type.
	 *
	 * @param options The options
	 * @return The material factory.
	 */
	static std::shared_ptr<IMaterialFactory>
	createMaterialFactory(const options::Options& options);
};
