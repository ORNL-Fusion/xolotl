...
{
/**
 * IPlot describe the structure needed to be able to plot data provided by
...
public:
	 ...
	 */
	virtual void
	setPlottingStyle(PlottingStyle style) = 0;
	...
	virtual void
	setDataProvider(
		std::shared_ptr<dataprovider::IDataProvider> dataProvider) = 0;
	 ...
	 */
	virtual void
	setLabelProvider(std::shared_ptr<LabelProvider> labelProvider) = 0;
	 ...
	 */
	virtual void
	setLogScale(bool logScale = true) = 0;
};
