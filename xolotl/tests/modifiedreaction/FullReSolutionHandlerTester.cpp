...
/**
 * This suite is responsible for testing the FullReSolutionHandler.
 */
BOOST_AUTO_TEST_SUITE(FullReSolutionHandler_testSuite)
...
BOOST_AUTO_TEST_CASE(checkReSolution) {
	...
	FullReSolutionHandler reSolutionHandler;
	...
	BOOST_REQUIRE_CLOSE(val[4], 0.0, 0.01); // Xe_1
