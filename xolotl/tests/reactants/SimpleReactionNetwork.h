...
public:
	...
	/**
		 ...
		 */
		std::shared_ptr<xolotlCore::Reactant> get(const std::string rName, const int size) const;
		 ...
		 */
		std::shared_ptr<xolotlCore::Reactant> getCompound(const std::string rName, const std::vector<int> sizes) const;
		 ...
		 */
		std::shared_ptr<std::vector<std::shared_ptr<xolotlCore::Reactant> > > getAll() const;
