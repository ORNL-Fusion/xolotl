...
namespace network
{
class LiClusterGenerator : public plsm::refine::Detector<LiClusterGenerator>
{
public:
	using Species = LiSpecies;
	using Superclass = plsm::refine::Detector<LiClusterGenerator>;
	...
	LiClusterGenerator(const options::IOptions& options);
