...
namespace network
{
class VClusterGenerator : public plsm::refine::Detector<VClusterGenerator>
{
public:
	using Species = VSpeciesList;
	using Superclass = plsm::refine::Detector<VClusterGenerator>;
	...
	VClusterGenerator(const options::IOptions& options);
