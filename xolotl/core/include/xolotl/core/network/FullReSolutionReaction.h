 ...
 * X_n -> n X_1 with a given rate
 *
 * @tparam TNetwork The network type
 * @tparam TDerived The derived class type.
 */
template <typename TNetwork, typename TDerived>
class FullReSolutionReaction : public Reaction<TNetwork, TDerived>
{
...
public:
	...
	FullReSolutionReaction() = default;

	KOKKOS_INLINE_FUNCTION
	FullReSolutionReaction(ReactionDataRef reactionData,
	...
	{
		return detail::CoefficientsView("FullReSolution Coefficients", size,
...
#include <xolotl/core/network/detail/FullReSolutionReactionGenerator.h>
