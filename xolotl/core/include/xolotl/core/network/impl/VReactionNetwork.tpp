...
#include <xolotl/core/network/impl/VClusterGenerator.tpp>
#include <xolotl/core/network/impl/VReaction.tpp>
...
void
VReactionGenerator::operator()(IndexType i, IndexType j, TTag tag) const
{
...
KOKKOS_INLINE_FUNCTION
void
VReactionGenerator::addSinks(IndexType i, TTag tag) const
{
	using Species = typename NetworkType::Species;
	using Composition = typename NetworkType::Composition;
...
inline ReactionCollection<VReactionGenerator::NetworkType>
VReactionGenerator::getReactionCollection() const
{
...
inline detail::VReactionGenerator
VReactionNetwork::getReactionGenerator() const noexcept
{
	return detail::VReactionGenerator{*this};
}
} // namespace network
} // namespace core
} // namespace xolotl
