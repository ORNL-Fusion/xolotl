...
KOKKOS_INLINE_FUNCTION
double
VProductionReaction::getRateForProduction(IndexType gridIndex)
{
	...
	return v::getRate(cl0.getRegion(), cl1.getRegion(), r0, r1, dc0, dc1);
}

KOKKOS_INLINE_FUNCTION
double
VDissociationReaction::getRateForProduction(IndexType gridIndex)
{
...
KOKKOS_INLINE_FUNCTION
double
VDissociationReaction::computeBindingEnergy(double time)
{
