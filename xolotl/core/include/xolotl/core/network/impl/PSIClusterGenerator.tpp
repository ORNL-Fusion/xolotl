...
//	// Interstitials
//	if (region[Species::I].begin() > 0 &&
//		(region[Species::He].begin() > 0 || region[Species::D].begin() > 0 ||
//			region[Species::T].begin() > 0 || region[Species::V].begin() > 0)) {
//		return false;
//	}
...
//			double aCubed = pow(latticeParameter, 3);
//			double termOne =
//				pow((3.0 / FourPi) * (1.0 / 10.0) * aCubed * comp[Species::D],
//					(1.0 / 3.0));
//			double termTwo =
//				pow((3.0 / FourPi) * (1.0 / 10.0) * aCubed, (1.0 / 3.0));
//			radius =
//				(impurityRadius + termOne - termTwo) * _hydrogenRadiusFactor;
//		}
//		else if (comp.isOnAxis(Species::T)) {
//			double FourPi = 4.0 * ::xolotl::core::pi;
//			double aCubed = pow(latticeParameter, 3);
//			double termOne =
//				pow((3.0 / FourPi) * (1.0 / 10.0) * aCubed * comp[Species::T],
//					(1.0 / 3.0));
//			double termTwo =
//				pow((3.0 / FourPi) * (1.0 / 10.0) * aCubed, (1.0 / 3.0));
//			radius =
...
// KOKKOS_INLINE_FUNCTION
// double
// PSIClusterGenerator<PSIFullSpeciesList>::getHeVFormationEnergy(
//	Composition comp) const noexcept
//{
//	// V formation energies in eV
//	constexpr Kokkos::Array<double, 2> vFormationEnergies = {3.6, 7.25};
...
// PSIClusterGenerator<PSIHeliumSpeciesList>::PSIClusterGenerator(
//	const options::IOptions& opts) :
//	_hydrogenRadiusFactor(opts.getHydrogenFactor()),
//	_maxHe(opts.getMaxImpurity()),
//	_maxV(opts.getMaxV()),
...
// KOKKOS_INLINE_FUNCTION
// bool
// PSIClusterGenerator<PSIHeliumSpeciesList>::refine(
//	const Region& region, BoolArray& result) const
//{
//	result[0] = true;
//	result[1] = true;
...
// KOKKOS_INLINE_FUNCTION
// bool
// PSIClusterGenerator<PSIHeliumSpeciesList>::select(const Region& region) const
//{
//	// Remove 0
...
//	// Helium
//	if (region[Species::He].begin() > _maxHe && region[Species::V].end() == 1 &&
//		region[Species::I].end() == 1) {
//		return false;
//	}
...
// KOKKOS_FUNCTION
// typename PSIClusterGenerator<PSIHeliumSpeciesList>::AmountType
// PSIClusterGenerator<PSIHeliumSpeciesList>::getMaxHePerV(
//	AmountType amtV, double ratio) noexcept
//{
//	/**
//	 * The maximum number of helium atoms that can be combined with a
...
// KOKKOS_INLINE_FUNCTION
// double
// PSIClusterGenerator<PSIHeliumSpeciesList>::getFormationEnergy(
//	const Cluster<PlsmContext>& cluster) const noexcept
//{
//	constexpr auto infinity = std::numeric_limits<double>::infinity();
...
// KOKKOS_INLINE_FUNCTION
// double
// PSIClusterGenerator<PSIHeliumSpeciesList>::getMigrationEnergy(
//	const Cluster<PlsmContext>& cluster) const noexcept
//{
//	// I migration energies in eV
//	constexpr Kokkos::Array<double, 6> iMigration = {
...
// KOKKOS_INLINE_FUNCTION
// double
// PSIClusterGenerator<PSIHeliumSpeciesList>::getDiffusionFactor(
//	const Cluster<PlsmContext>& cluster, double latticeParameter) const noexcept
//{
//	// I diffusion factors in nm^2/s
//	constexpr Kokkos::Array<double, 6> iDiffusion = {
...
// KOKKOS_INLINE_FUNCTION
// double
// PSIClusterGenerator<PSIHeliumSpeciesList>::getReactionRadius(
//	const Cluster<PlsmContext>& cluster, double latticeParameter,
//	double interstitialBias, double impurityRadius) const noexcept
//{
//	const auto& reg = cluster.getRegion();
...
// KOKKOS_INLINE_FUNCTION
// double
// PSIClusterGenerator<PSIHeliumSpeciesList>::getHeVFormationEnergy(
//	Composition comp) const noexcept
//{
//	// V formation energies in eV
//	constexpr Kokkos::Array<double, 2> vFormationEnergies = {3.6, 7.25};
