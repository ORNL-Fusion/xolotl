...
bool
VClusterGenerator::refine(const Region& region, BoolArray& result) const
{
	result[0] = true;
	result[1] = true;
	result[2] = true;
...
KOKKOS_INLINE_FUNCTION
bool
VClusterGenerator::select(const Region& region) const
{
	// Remove 0
...
KOKKOS_INLINE_FUNCTION
double
VClusterGenerator::getMigrationEnergy(
...
KOKKOS_INLINE_FUNCTION
double
VClusterGenerator::getDiffusionFactor(
...
KOKKOS_INLINE_FUNCTION
double
VClusterGenerator::getReactionRadius(const Cluster<PlsmContext>& cluster,
