...
void
ReactionGeneratorBase<TNetwork, TDerived>::addProductionReaction(Count,
...
KOKKOS_INLINE_FUNCTION
void
ReactionGeneratorBase<TNetwork, TDerived>::addProductionReaction(Construct,
    const ClusterSet& clusterSet) const
{
    if (!_clusterData.enableStdReaction(0)) return;
...
KOKKOS_INLINE_FUNCTION
void
ReactionGeneratorBase<TNetwork, TDerived>::addDissociationReaction(Count,
    const ClusterSet& clusterSet) const
{
    if (!_clusterData.enableStdReaction(0)) return;
...
KOKKOS_INLINE_FUNCTION
void
ReactionGeneratorBase<TNetwork, TDerived>::addDissociationReaction(Construct,
    const ClusterSet& clusterSet) const
{
    if (!_clusterData.enableStdReaction(0)) return;
