...
NucleationReactionGenerator<TBase>::NucleationReactionGenerator(
	...
	_clusterNucleationReactionCounts(
		"Nucleation Reaction Counts", Superclass::getNumberOfClusters())
{
}
...
NucleationReactionGenerator<TBase>::getRowMapAndTotalReactionCount()
{
	...
	_numNucleationReactions = Kokkos::get_crs_row_map_from_counts(
		_nucleationCrsRowMap, _clusterNucleationReactionCounts);

	_nucleationReactions = Kokkos::View<NucleationReactionType*>(
		"Nucleation Reactions", _numNucleationReactions);
