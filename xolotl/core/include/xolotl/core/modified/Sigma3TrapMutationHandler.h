 ...
 * grain boundary. It helps the main trap mutation handler filling its index
 * vector.
 */
class Sigma3TrapMutationHandler
{
private:
	/** The vector containing the different distances for the modified
	 * trap-mutation associated with the GB
	 */
