 ...
 */
PSIClusterNetworkLoader::PSIClusterNetworkLoader() : Reactant() {
}
 ...
 * loaded.
 */
PSIClusterNetworkLoader::PSIClusterNetworkLoader(std::istream inputstream) : Reactant() {
}
 ...
 * loaded.
 */
void PSIClusterNetworkLoader::setInputstream(std::istream inputstream) {
}
