#ifndef ALLOYCLUSTER_H
#define ALLOYCLUSTER_H
...
/**
 * The AlloyCluster class is a Reactant that is specialized to work for
 ...
 *
 * AlloyClusters must always be initialized with a size. If the constructor is
 ...
 * return a map with the keys I, V, bubble, faulted, frank, perfect.
 * The operation getTypeName() will always return one of the same values.
 *
 ...
 */
class AlloyCluster: public Reactant {
...
protected:
	...
	public:
		...
		//! The constructor
		ClusterPair(AlloyCluster * firstPtr, AlloyCluster * secondPtr) :
	...
	public:
		...
		//! The constructor
		CombiningCluster(AlloyCluster * ptr) :
...
public:
	 ...
	 */
	AlloyCluster(std::shared_ptr<xolotlPerf::IHandlerRegistry> registry);
	 ...
	 */
	AlloyCluster(AlloyCluster &other);

	/**
	 * The destructor
	 */
	virtual ~AlloyCluster() {
	}
	...
	virtual std::shared_ptr<IReactant> clone() {
		return std::shared_ptr<IReactant>(new AlloyCluster(*this));
	}
