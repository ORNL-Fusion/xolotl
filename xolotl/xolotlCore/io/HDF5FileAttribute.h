...
HDF5File::Attribute<std::vector<T>>::setTo(const std::vector<T>& value) const
{
    ...
    {
        throw HDF5Exception("Size mismatch when setting vector-valued attribute");
    }
...
template<>
void
HDF5File::Attribute<std::vector<std::string>>::setTo(const std::vector<std::string>& value) const;
