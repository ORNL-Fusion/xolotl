...
class PAPIHardwareCounter : public IHardwareCounter, public xolotlCore::Identifiable
{
private:
...
public:
    ...
    ///
    virtual const ValType& getValues( void ) const  { return vals; }
	...
	///
    virtual const SpecType& getSpecification( void ) const  { return spec; }
