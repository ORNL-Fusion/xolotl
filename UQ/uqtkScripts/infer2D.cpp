...
#include "PCBasis.h"
#include "XMLUtils.h"
#include "XMLreader2D.h"
#include "posterior2D.h"
#include "uqtkmcmc.h"
#include "uqtktools.h"
#include <math.h>
...
/// \brief Example that infers parameters of a model given data measureements on
/// its outputs
...
main(int argc, char* argv[])
{
	...
	// Read the xml tree
	RefPtr<XMLElement> xmlTree = readXMLTree("infer2D.xml");
